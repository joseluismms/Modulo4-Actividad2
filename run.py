...
def root():
    ...
    return {'Proyecto':'Mod. 4 - Ciclo de vida de modelos IA - Alumno: Jose Luis Muñoz de Morales Silva'}
...
def train_model_route():
    ...
    return {'TRAINING MODEL': 'Mod. 4 - Ciclo de vida de modelos IA - Alumno: Jose Luis Muñoz de Morales Silva'}
