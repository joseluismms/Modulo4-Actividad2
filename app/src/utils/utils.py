...
class IBMCOS:
    ...
    def __init__(self, ibm_api_key_id, ibm_service_instance_id, ibm_auth_endpoint, endpoint_url):
        ...
        """
        print("Constructor de la conexión a IBM COS for new bucket")
        print("ibm_api_key_id=",ibm_api_key_id)
        print("ibm_service_instance_id=",ibm_service_instance_id)
        print("ibm_auth_endpoint=",ibm_auth_endpoint)
    ...
    def save_object_in_cos(self, obj, name, timestamp, bucket_name='models-uem-jlm'):
        """
        ...
        try:
            ...
            print("utils.py > save_object_in_cos(..) > guardado del objeto en COS con bucket_name=",bucket_name)
    ...
    def get_object_in_cos(self, key, bucket_name='models-uem-jlm'):
        """
